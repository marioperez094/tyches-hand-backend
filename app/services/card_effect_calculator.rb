class CardEffectCalculator
  EFFECT_DETAILS = {
    "Exhumed" => {
      ...
      description: ->(name) { "An #{name}, cards ripped from a corpse's stiff grip." },
    ...
    "Charred" => {
      ...
      description: ->(name) { "A #{name}, the embers on these cards can still cauterize wounds." },
    ...
    "Fleshwoven" => {
      ...
      description: ->(name) { "A #{name}, these cards appear to have a leathery texture and an odd familiarity." },
    ...
    "Blessed" => {
      ...
      description: ->(name) { "A #{name}, the cards are blinding, and sizzles to the touch." },
    ...
    "Bloodstained" => {
      ...
      description: ->(name) { "A #{name}, the cards are matted together by blood, filling the room with their foul odor." },
  ...
  def description
    EFFECT_DETAILS.dig(@effect, :description)&.call(@card_name) || "A #{@card_name}"
  end
